...
public class Print {
    ...
    private static List<Student> getStudentsWithoutClass(List<SchoolClass> schoolClassList, List<Student> studentList) {
     ...
     * @throws IOException
     */
    public static void changeClassData(SchoolClass schoolClass, List<Teacher> teacherList, List<Student> studentList) throws IOException {
        System.out.println(WHICH_DATA_SHOULD_BE_CHANGED);
        ...
        switch (reader.readLine().toLowerCase(Locale.ROOT)) {
            ...
            case "name":
                schoolClass.setName(new Name(chooseName()));
            default:
                break;
        }
    }
